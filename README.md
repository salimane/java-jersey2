...
<pre>
mvn -P default clean package -Dlog4j.configuration=file:./conf/log4j.properties tomcat7:run-war
</pre>

This will start Tomcat7 embedded on port 8002.

### Testing the server
Once started, you can navigate to http://localhost:8002/api/v1/api-docs.json to view the Swagger Resource Listing.
